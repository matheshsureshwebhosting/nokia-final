            ...
            <>
                ...
                <Table striped bordered hover dir="ltr" border="1" cellSpacing="0" cellPadding="0"><colgroup><col width="100" /><col width="100" /><col width="128" /><col width="100" /><col width="100" /><col width="117" /><col width="100" /></colgroup>
                    <tbody>
                        ...
                        {thermal.length !== 0 ? thermal.map((thermaltable, index) => (
                           <tr style={{ height: "13px" }} key={index}>
                           <td style={{ height: "13px", textAlign: "center" }}>{thermaltable.date}</td>
                           <td style={{ height: "13px", textAlign: "center" }}>{thermaltable.shift}</td>
                           <td style={{ height: "13px", textAlign: "center" }}>{thermaltable.machine_Sl_No}</td>
                           <td style={{ height: "13px", textAlign: "center" }}>{thermaltable.checked_by}</td>
                           <td style={{ height: "13px", textAlign: "center" }}>{thermaltable.machine_Sl_No}</td>
                           <td style={{ height: "13px", textAlign: "center" }}>{thermaltable.status}</td>
                           <td style={{ height: "13px", textAlign: "center" }}>{thermaltable.status !== "Complete" ? thermaltable.statuslists : "-"}</td>                                                                                        
                           <td style={{ height: "13px", textAlign: "center" }}>{thermaltable.average}</td>
