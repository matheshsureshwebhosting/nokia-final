    ...
    return (
        ...
        <>
            ...
            <div className=" bg-transparent d-flex justify-content-center align-items-center master-checklist-btn w-100">
                ...
                {props.inputField && <div className="px-4" style={{ fontSize: "1.25rem", fontWeight: "600" }}>Enter Pressure Guage Value: <input type='text' onChange={(e)=>props.onChange(e)} placeholder={props.placeholder} value={props.value} /></div>}
            </div>
        </>
    )
}
